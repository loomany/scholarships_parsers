...
def source_enabled(canonical_key: str) -> bool:
    ...
    if canonical_key == "mastersportal":
        return get_bool("MASTERSPORTAL_ENABLED", False)
    if canonical_key == "scholars4dev":
    ...
    if canonical_key == "daad":
        return get_bool("DAAD_ENABLED", False)
    ...
    if canonical_key == "unigo":
        return get_bool("UNIGO_ENABLED", False)
    return True
